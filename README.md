...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:203a43,100:2c5364&height=260&section=header&text=Nikhil%20Rupala&fontSize=56&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=AI%20%26%20Machine%20Learning%20Engineer%20%7C%20Backend%20%26%20Cloud%20Builder&descAlignY=55&descSize=19" width="100%"/>
...
My current focus spans **Deep Learning, Large Language Models, Agentic AI, Backend Development, and Cloud Infrastructure**, with an emphasis on writing clean, scalable, and maintainable code.

> 🎯 **Objective** — Build intelligent software that solves real-world problems through AI, ML, backend engineering, and cloud computing — learning continuously and shipping production-grade solutions.
...
| 🧠 AI / ML | ⚙️ Backend | ☁️ Cloud & MLOps |
|:---:|:---:|:---:|
| Machine Learning | REST API Design | AWS |
| Deep Learning | System Design | Docker & Kubernetes |
| Computer Vision | Distributed Systems | CI/CD Pipelines |
| LLMs & Agentic AI | Database Engineering | MLOps Workflows |
...
<img src="https://skillicons.dev/icons?i=mongodb,mysql,docker,kubernetes,aws" />
...
<img src="https://img.shields.io/badge/Cloud_Architecture-FF9900?style=for-the-badge" />
...
> Actively building AI, backend, and cloud-native projects — this section is updated as new work ships.
